  ...
  const currentYear = getDate.getFullYear();
	return (
        ...
        <p className="text-lg text-primary">Cordless Tools Terminal</p>
			...
			<div>
				<p>Copyright &copy; {currentYear} - All right reserved by Cordless Tools Terminal</p>
				<p>Developed by <a href="https://github.com/theophildio" target="_blank" rel="noreferrer" className="text-primary">Theophil Dio</a></p>
			</div>
		</footer>
	);
};
